...
//     gel('msg').innerHTML= gel('mm').value + ' MM = ' + gel('cm').value + ' CM = ' + gel('inch').value + ' inches = ' + sTemp;
//     drawruler();
...
//     //ruler for inch
//     cxt.strokeStyle ='#000000';//color line
//     cxt.fillStyle="#000000";
//     cxt.lineWidth=1;//defined widht
//     cxt.beginPath();
//     cxt.moveTo(0,BL_inch);
//     cxt.lineTo(w,BL_inch);
//     cxt.stroke();//picture frame
...
//     cxt.beginPath();
//     cxt.clearRect(begin_x+(w/2)-(txt_width/2)-10,60,txt_width+20,10);
...
//     Materialize.toast('Configuração Salva :)', 4000)
//   } else {
